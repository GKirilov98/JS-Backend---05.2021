...
router.post('/register', isGuest(),
    validator.body('username')
        .isLength({min: 3}).withMessage("Username must be at least 3 chars length!")
        .bail()
        .matches(/^[a-zA-Z0-9]+$/i).withMessage("Username can contains only english letters and digits."),
    // .bail() Use to chain validations
    validator.body('password')
        .isLength({min: 3}).withMessage("Password must be at least 3 chars length")
        .bail()
